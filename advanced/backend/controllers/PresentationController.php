...
class PresentationController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            // TODO: move to model Presentation - before save
            $model->user_id = Yii::$app->user->identity->id;
            $model->rating = 0; // TODO: count presentations for the current user
            $model->public_url = Yii::$app->security->generateRandomString();
            $model->image_preview = ''; // get selected page number, create image, safe it to web folder, set url here
